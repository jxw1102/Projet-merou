...
class CTLGrammar_All extends JavaTokenParsers  {
  ...
  lazy val exp1: Parser[String] =  funcall |parenth |floatingPointNumber | ident
 ...
 object MyParseree extends CTLGrammar_All{
