...
object Main extends App {
    ...
    // do not display results with negative environment
    def printTest(msg: String, checker: Checker, test: CTL) = println(msg + checker.evalExpr(test).filterNot(_._2 match {
