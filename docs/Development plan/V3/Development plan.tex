...
\fancyhead[L]{March $9^{th}$ 2015}
\fancyhead[R]{\textbf{Reference :} model-checking.dev-plan - Version 4}
...
\node[
 ...
 at ([yshift=-2.5cm]current page.north west) (blackrect) {Development plan - Version 4};
% the khaki stripe
