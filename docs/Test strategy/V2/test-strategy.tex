...
\fancyhead[L]{March $9^{rd}$, 2015}
\fancyhead[R]{\textbf{Reference :} model-checking.test-strategy - Version 3}
...
\node[
 ...
 at ([yshift=-2.5cm]current page.north west) (blackrect) {Test strategy and results - Version 3};
% the khaki stripe
